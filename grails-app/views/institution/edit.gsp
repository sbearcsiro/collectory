                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'description', 'errors')}">
                                    <g:textArea name="description" cols="60" rows="20" value="${providerGroupInstance?.description}" />
                                </td>
                            </tr>
...
<!-- address -->            <tr class="prop">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'parents', 'errors')}">
                                    <g:select name="parents" from="${au.org.ala.collectory.ProviderGroup.list()}" multiple="yes" optionKey="id" size="5" value="${providerGroupInstance?.parents}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'children', 'errors')}">
                                    <g:select name="children" from="${au.org.ala.collectory.ProviderGroup.list()}" multiple="yes" optionKey="id" size="5" value="${providerGroupInstance?.children}" />
                                </td>
                            </tr>

                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="sources"><g:message code="providerGroup.sources.label" default="Sources" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'sources', 'errors')}">
                                    <g:select name="sources" from="${au.org.ala.collectory.InfoSource.list()}" multiple="yes" optionKey="id" size="5" value="${providerGroupInstance?.sources*.id}" />
                                </td>
                            </tr>

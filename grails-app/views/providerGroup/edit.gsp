                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="parents"><g:message code="providerGroup.parents.label" default="Parents" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'parents', 'errors')}">
                                    <g:select name="parents" from="${au.org.ala.collectory.ProviderGroup.list()}" multiple="yes" optionKey="id" size="5" value="${providerGroupInstance?.parents*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="children"><g:message code="providerGroup.children.label" default="Children" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'children', 'errors')}">
                                    <g:select name="children" from="${au.org.ala.collectory.ProviderGroup.list()}" multiple="yes" optionKey="id" size="5" value="${providerGroupInstance?.children*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="listOfCollectionCodesForLookup"><g:message code="providerGroup.listOfCollectionCodesForLookup.label" default="List Of Collection Codes For Lookup" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'listOfCollectionCodesForLookup', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="listOfInstitutionCodesForLookup"><g:message code="providerGroup.listOfInstitutionCodesForLookup.label" default="List Of Institution Codes For Lookup" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'listOfInstitutionCodesForLookup', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="parentInstitutionsOrderedByName"><g:message code="providerGroup.parentInstitutionsOrderedByName.label" default="Parent Institutions Ordered By Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'parentInstitutionsOrderedByName', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="safeChildren"><g:message code="providerGroup.safeChildren.label" default="Safe Children" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: providerGroupInstance, field: 'safeChildren', 'errors')}">

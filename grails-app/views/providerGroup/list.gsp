                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="description" title="${message(code: 'providerGroup.description.label', default: 'Description')}" />
                    ...
                    <g:each in="${providerGroupInstanceList}" status="i" var="providerGroupInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: providerGroupInstance, field: "description")}</td>

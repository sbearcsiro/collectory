            ...
            <div class="dialog">
              <table>
                ...
                <tr class="reportGroupTitle"><td>CHAH Members (${reports.chahMembers.size()})</td>
                  <!-- put first member on same line as title -->
                  <td colspan="2">
                    <g:if test="${reports.chahMembers.size() > 0}"><cl:showOrEdit entity="${reports.chahMembers[0]}"/></g:if><g:else>None</g:else>
                  </td></tr>
                <!-- skip first member -->
                ...
                <tr class="reportGroupTitle"><td>CHAFC Members (${reports.chafcMembers.size()})</td>
                  <!-- put first member on same line as title -->
                  <td colspan="2">
                    <g:if test="${reports.chafcMembers.size() > 0}"><cl:showOrEdit entity="${reports.chafcMembers[0]}"/></g:if><g:else>None</g:else>
                  </td></tr>
                ...
                <tr class="reportGroupTitle"><td>CHAEC Members (${reports.chaecMembers.size()})</td>
                  <!-- put first member on same line as title -->
                  <td colspan="2">
                    <g:if test="${reports.chaecMembers.size() > 0}"><cl:showOrEdit entity="${reports.chaecMembers[0]}"/></g:if><g:else>None</g:else>
                  </td></tr>
                ...
                <tr class="reportGroupTitle"><td>CHACM Members (${reports.amrrnMembers.size()})</td>
                  <!-- put first member on same line as title -->
                  <td colspan="2">
                    <g:if test="${reports.amrrnMembers.size() > 0}"><cl:showOrEdit entity="${reports.amrrnMembers[0]}"/></g:if><g:else>None</g:else>
                  </td></tr>
                ...
                <tr class="reportGroupTitle"><td>CAMD Members (${reports.camdMembers.size()})</td>
                  <!-- put first member on same line as title -->
                  <td colspan="2">
                    <g:if test="${reports.camdMembers.size() > 0}"><cl:showOrEdit entity="${reports.camdMembers[0]}"/></g:if><g:else>None</g:else>
                  </td></tr>

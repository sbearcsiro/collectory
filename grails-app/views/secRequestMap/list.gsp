<head>
	...
	<title>SecRequestMap List</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="create" action="create">New SecRequestMap</g:link></span>
	</div>

	<div class="body">
		<h1>SecRequestMap List</h1>
		...
		<div class="paginateButtons">
			<g:paginate total="${au.org.ala.security.SecRequestMap.count()}" />
		</div>

...
eventWebXmlStart = {
    if (!ConfigurationHolder.config.security.cas.bypass) {
        ...
        println "Injecting CAS Security Configuration: authenticateOnlyIfLoggedIn url pattern = ${ConfigurationHolder.config.security.cas.authenticateOnlyIfLoggedInPattern}"
